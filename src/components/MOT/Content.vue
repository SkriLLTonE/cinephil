<template>
    <section class="main__video">
        ...
        <Swiper
                :modules="modules" :space-between="25" :navigation="true" :breakpoints="swiperOptions.breakpoints">
            <SwiperSlide class="main__video-item"
                         v-for="(item, i) in content" :key="item.id">
                <img class="main__video-item-img" :src="imgUrlFull + item.poster_path" alt="">
